 ...
 *
 * @Notice
 * Almost everything in this file has been modified from its original Google implementation found under
...
export class Camera {
  ...
  static async setupCamera(cameraParam) {
    ...
    canvasContainer.style = `width: ${$size.width}px; height: ${$size.height}px`;
    const videoConfig = {
      audio: false,
      video: {
        facingMode: 'user',
